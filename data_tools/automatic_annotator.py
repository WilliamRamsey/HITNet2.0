...
# Creates directory 
# 
def annotate_images(path_to_model, path_to_images):
...
path_to_images = "C:/Users/willi/OneDrive/Desktop/HITNET/data/datasets/Auto-Segmented"
annotate_images(path_to_model, path_to_images)